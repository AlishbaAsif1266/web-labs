...
//Implicit Return
const isEvenFunction = function(num){
    return num % 2 === 0;
}
const isEvenArrow1 = (num) => {
    return num % 2 === 0;
}
const isEvenArrow2 = num => {
    return num % 2 === 0;
}
const isEvenArrow3 = num => {
    num % 2 === 0
};
const isEvenArrow4 = num => num % 2 === 0;
console.log("isEvenFunction(4):", isEvenFunction(4));   
console.log("isEvenArrow1(5):", isEvenArrow1(5));       
console.log("isEvenArrow2(10):", isEvenArrow2(10));    
console.log("isEvenArrow3(8):", isEvenArrow3(8));       
console.log("isEvenArrow4(12):", isEvenArrow4(12));
...
let movie = moviesList.find(movie => {
    return movie.includes('Kung')
})
let movie2 = moviesList.find(m => m.indexOf('Twits') === 0);
console.log("movie:", movie);  
console.log("movie2:", movie2);

//Filter
const numberList = [9, 8, 7, 6, 5, 4, 3, 2, 1];
const odds = numberList.filter(n => {
    return n % 2 === 1; 
});
const smallNums = numberList.filter(n => n < 5); 
console.log("Odd numbers:", odds);
console.log("Numbers < 5:", smallNums);

//every
const words = ["dog", "dig", "log", "wag"];
const allThreeLetters = words.every(word => {
    return word.length === 3;
});
const allStartWithD = words.every(word => word[0] === 'd');
const allEndWithG = words.every(w => {
    let last_letter = w[w.length - 1];
    return last_letter === 'g';
});

console.log("All words have 3 letters:", allThreeLetters);
console.log("All words start with 'd':", allStartWithD);
console.log("All words end with 'g':", allEndWithG);
